...
def validate_samplesheet(samplesheet_file):
    ...
    with open(samplesheet_file, 'r') as file:
        ...
        for row in reader:
            ...
            fastq_1_path = os.path.join("../../../", fastq_1)
            fastq_2_path = os.path.join("../../../", fastq_2)
            ...
            if not fastq_1 or not fastq_2:
                ...
                if not fastq_1.endswith(".fastq.gz"):
                    ...
                    print(f"ERROR: File '{ os.path.basename(fastq_1)}' for sample '{sample}' does not exist at '{fastq_1_path}'.")
                    valid = False
                ...
                if not fastq_2.endswith(".fastq.gz"):
                    ...
                    print(f"ERROR: File '{ os.path.basename(fastq_2)}' for sample '{sample}' does not exist at '{fastq_2_path}'.")
                    valid = False
